...
\begin{ssection}{Probabilistic Modelling of Data}
	...
	\begin{ssubsection}{Parameter Estimation}
		...
		\defn{Likelihood Function}{This is the observation model that specifies how data is generated. This measures the data fit w.r.t. to the given parameters $\vtheta$ and is represented by the conditional property $\prob{\vX \pipe \vtheta}$} \br

		\defn{Prior Distribution}{Prior Distribution specifies how likely different parameter values are a priori. This also acts as a regularizer to the model and is represented by the prior probability $\prob{\vtheta}$} \br
